...
export default function UpdateVariantForm({ id, name, closeSheet }: UpdateVariantFormProps) {
    const [errors, setErrors] = useState<Record<string, string>>({});

    const { updateVariant } = useVariantMutation();
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}>
                ...
                <div className="grid gap-4">
                    ...
                    <Button type="submit" loading={updateVariant.isPending} className="" size="sm">
                        Simpan Perubahan
                    </Button>
                </div>
            </form>
