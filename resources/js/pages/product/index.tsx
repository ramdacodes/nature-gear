...
import { columnLabel, columns, CreateProductForm } from '@/pages/product/components';
import { ProductContext } from '@/pages/product/product.context';
...
export default function Product() {
    ...
    const { deleteMultipleProduct } = useProductMutation();

    const tableQuery = useTableQuery({
        queryKey: [PRODUCT_LIST, columnFilters, globalFilter, pagination, sorting],
    ...
    return (
        <ProductContext.Provider value={{ sheetOpen, setSheetOpen, queryClient }}>
                            ...
                            <div className="flex flex-col gap-2 sm:flex-row sm:gap-2">
                                <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
                                    ...
                                    <SheetContent className="scrollbar-hide max-h-screen overflow-y-scroll">
                                        <SheetHeader>
                                            <SheetTitle>Tambah Data Produk</SheetTitle>
                                            <SheetDescription>Lengkapi data dibawah ini untuk menambahkan produk</SheetDescription>
                                        </SheetHeader>
                                        <div className="mt-4">
                                            <CreateProductForm />
                                        </div>
