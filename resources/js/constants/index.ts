...
export const USER_ADMIN_LIST = 'user-admin-list';
export const USER_CUSTOMER_LIST = 'user-customer-list';
export const USER_STAFF_LIST = 'user-staff-list';

export const WEB_PRODUCT_LIST = 'web-product-list';
